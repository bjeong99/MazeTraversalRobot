...
void dfs()
{
  ...
  else if (current_dir == 1)
  {
    ...
    if (!isWall(distL) && visited_nodes[current_node.x][current_node.y + 1] == false)
    {
    ...
    else if (!isWall(distC) && visited_nodes[current_node.x + 1][current_node.y] == false)
    {
  ...
  else if (current_dir == 2)
  {
    ...
    if (!isWall(distL) && visited_nodes[current_node.x + 1][current_node.y] == false)
    {
    ...
    else if (!isWall(distC) && visited_nodes[current_node.x][current_node.y - 1] == false)
    {
  ...
  else if (current_dir == 3)
  {
    ...
    if (!isWall(distR) && visited_nodes[current_node.x][current_node.y + 1] == false)
    {
